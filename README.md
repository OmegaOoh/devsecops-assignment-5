...
## How to run
1. Create secret for mongo called `mongo-user` (base64 encoded user for MongoDB) and mongo-password (base64 encoded password for MongoDB)
...
3. run following commands in order (mongo-secret.yaml can be skipped if not exist)
```bash
